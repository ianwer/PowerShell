...
.EXAMPLE
	...
	.\Get-ScheduledTask.ps1 -ComputerName <ComputerName> | Where-Object {$_.Name -like '*Xpert*'} | Select-Object ComputerName, Name, State
	#?Get-ScheduledTask.ps1 -ComputerName <ComputerName> | Where-Object {$_.Name -like '*Xpert*'} | Select-Object ComputerName, Name, State
...
.EXAMPLE
	...
	Get-Content Servers.txt | ForEach-Object { .\Get-ScheduledTask.ps1 -ComputerName $_ | Where-Object {$_.Name -like '*Xpert*'} | Select-Object ComputerName, Name, State}
